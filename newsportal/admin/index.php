                                ...
                                <div class="text-center account-logo-box">
                                    <h2 class="">
                                        <a href="index.html" class="text-success">
                                            <span>Furaha</span><br>
                                            <span class="text-white">Newletter</span>
                                        </a>
                                    </h2>
                                ...
                                <div class="account-content">
                                    <form class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group ">
                                            <div class="col-xs-12">
                                                <input class="form-control P-3" type="text" required="" name="username" placeholder="Username or email" autocomplete="off">
                                            </div>
                                        </div>
